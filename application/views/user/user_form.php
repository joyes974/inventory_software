        ...
        <table cellspacing='1' cellpadding='2' width='100%' class='pad_10'>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class='block'><input type='checkbox' name='permission[]' value='1' <?php if($permission==1||$permission==3){echo 'checked';}?> /> Only Purchase</label>
                    <label class='block'><input type='checkbox' name='permission[]' value='2'  <?php if($permission==2||$permission==3){echo 'checked';}?> /> Only Sale</label>
                </td>
            </tr>
            <tr><th>&nbsp;</th>
                <td>
