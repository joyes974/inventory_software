<div class="form_content">
    ...
    <form name="search_purchase" action="<?=site_url('payment')?>" method="POST">
    <table>
        <tr>
...
<div class='grid_area'>
    ...
    <div class="tooolbars">
        ...
        <button id="add" title="payment/add_payment"  class="jadd_button">Add</button>

        <!--<button title="rawmaterials/edit_rm_release" class="jedit_button">Edit</button>-->
        <button title="payment/delete_payment" class="jdelete_button">Delete</button>
        <button id="add" title="payment/show_received_report"  class="jadd_button">Show Report</button>
