<div class="form_content portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" style="width:900px;margin-top:50px;">
   ...
   <div class="portlet-content">
    ...
    <form id="rm_release" method='post' action='<?=site_url('rawmaterials/edit_rm_release/'.$id);?>' enctype="multipart/form-data">
  Raw Materials Release
        <table>
            ...
            <tr>
                ...
                <td><input type='text' id="date" class="input_txt width_150 total_quantity number date_picker" name='date' value="<?=$date?>"/><?=form_error('date','<span>','</span>')?></td>
            </tr>
            
             <tr>
                <th>Released Item<span class='req_mark'>*</span>:</th>

                <td><?php  echo $this->raw_model->get_items($item_id)?>
            ...
            <tr>
                ...
                <td><input type='text' id="amount" class="input_txt width_150 discount number" name='amount' value="<?= $amount ?>" /><?=form_error('amount','<span>','</span>')?></td>
            </tr>
             ...
             <tr>
                ...
                <td><input type='text' id="batch" class="input_txt width_150 discount number" name='batch' value="<?= $batch ?>" /><?=form_error('batch','<span>','</span>')?></td>
            </tr>
